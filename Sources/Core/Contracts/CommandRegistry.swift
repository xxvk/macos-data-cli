...
public enum CommandRegistry {
    ...
    public static func standard(version: String) -> CommandManifest {
        CommandManifest(
            ...
            commands: [agent, resources, contacts, mail, calendar, reminders, photos, notes, shortcuts, safari, messages, phoneCalls],
            schemas: schemas
        )
    }
    ...
    static func group(name: String, description: String, usage: String? = nil, subcommands: [CommandNode]) -> CommandNode {
        CommandNode(
            name: name, kind: .group, description: description, usage: usage ?? "mpia \(name) <command>",
