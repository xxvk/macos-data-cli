...
public enum PhotoAlbumPagination {
    private static let prefix = "photoalbumpage_"

    public static func page(
        items: [PhotoAlbumPayload],
        kind: PhotoAlbumQueryKind,
        limit: Int,
        cursor: String?,
        complete: Bool
        ...
        let fingerprint = digest("photo-albums-v1:\(kind.rawValue):hierarchy-v1")
    ...
    private static func startIndex(_ cursor: String?, items: [PhotoAlbumPayload], fingerprint: String) throws -> Int {
    ...
    private static func encode(id: String, fingerprint: String) -> String {
        prefix + Data("photo-albums-v1:\(fingerprint):\(digest(id))".utf8).base64EncodedString()
            .replacingOccurrences(of: "+", with: "-")
